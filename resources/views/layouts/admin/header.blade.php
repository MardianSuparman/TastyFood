        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ms-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#"
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0"> <img
                                        src="{{ asset('assets/back/assets/img/user1-128x128.jpg') }}" alt="User Avatar"
                        ...
                        <div class="dropdown-divider"></div> <a href="#" class="dropdown-item">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0"> <img
                                        src="{{ asset('assets/back/assets/img/user8-128x128.jpg') }}" alt="User Avatar"
                                        class="img-size-50 rounded-circle me-3"> </div>
                                <div class="flex-grow-1">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
                        ...
                        <div class="dropdown-divider"></div> <a href="#" class="dropdown-item">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0"> <img
                                        src="{{ asset('assets/back/assets/img/user3-128x128.jpg') }}" alt="User Avatar"
                                        class="img-size-50 rounded-circle me-3"> </div>
                                <div class="flex-grow-1">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
                ...
                <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                        ...
                        {{-- <img src="{{ asset('assets/back/assets/img/user2-160x160.jpg') }}"
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                        ...
                        <!--begin::User Image-->
                        <li class="user-header text-bg-primary" style="display: flex; justify-content: center; align-items: center; text-align: center; height: 100px;">
                            {{-- <img src="{{ asset('assets/back/assets/img/user2-160x160.jpg') }}"
