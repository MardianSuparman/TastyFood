...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/back/css/adminlte.css') }}"><!--end::Required Plugin(AdminLTE)-->
...
<body class="register-page bg-body-secondary">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="input-group mb-1">
                        <div class="form-floating">
                            <input id="registerConfirmPassword" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
    ...
    <script src="{{ asset('assets/back/js/adminlte.js') }}"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script>
